...
public class Itinerary {
    ...
    private final AddOn nightEntertainment = new AddOn("Night Entertainment", 1800, "itinerary", "NEP");
    private final AddOn explorerJournal = new AddOn("Journal Kit", 400, "itinerary", "EJK");
     ...
     *
     * @param addOnName The add-on name to be checked.
